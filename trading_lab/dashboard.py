...
class DashboardGenerator:
    ...
    def generate_html(self) -> str:
        ...
        html = [
            ...
            "    </style>",
            "</head>",
            f"<body class='min-h-screen p-4 md:p-8' x-data=\"{{ tab: 'overview' }}\">",
            ...
            "            <button @click=\"tab = 'analytics'; if(!window.chartInit) { window.initChart(); window.chartInit=true; }\" :class=\"{'active': tab === 'analytics'}\" class='nav-tab'>Analytics</button>",
        ...
        html.extend([
            ...
            f"            const labels = {json.dumps(pnl_labels)};",
            f"            const data = {json.dumps(pnl_data)};",
